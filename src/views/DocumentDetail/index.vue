    ...
    <div class="below-containner">
      <el-row class="detail-container">
        ...
        <el-col :md="8">
          ...
          <el-pagination small layout="prev, pager, next" :total="correctRef.length" :page-size="pageSize"
...
export default {
  ...
  computed: {
    correctRef: function () {
      return this.documentInfo.ref.filter((ref) => {
        return ref.title != null && ref.title.substring(0, 11) !== 'Xamarin Bug'
      });
    },
    displayRef: function () {
